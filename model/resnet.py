...
class ResidualBlock(nn.Cell):
    ...
    Args:
        ...
        padding(int): use in conv2. Default:0.
        dilation(int): use in conv2. Default:1.
    ...
    def __init__(self,
        ...
        if self.use_se and self.stride != 1:
            ...
            self.conv2 = _conv3x3(channel, channel, stride=stride, use_se=self.use_se, padding=padding, dilation=dilation)
...
class ResNet(nn.Cell):
    ...
    def _make_layer(self, block, layer_num, in_channel, out_channel, stride, use_se=False, se_block=False, dilation=1):
        """
        ...
        resnet_block = block(in_channel, out_channel, stride=stride, use_se=use_se, padding=1, dilation=dilation)
...
def resnet50(class_num=10, last_conv_stride=2, last_conv_dilation=1):
    """
    Get ResNet50 neural network.

    Args:
        class_num (int): Class number.
        last_conv_stride: Default: 2.
        last_conv_dilation: Default: 0.
